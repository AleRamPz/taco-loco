...
st.markdown("""
    ...
    <style> 
    # --- ESTILOS CSS FINALES (CON MODO KIOSCO ACTIVADO) ---
st.markdown("""
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;700;900&display=swap" rel="stylesheet">
    ...
    /* --- OCULTAR INTERFAZ DE STREAMLIT (MODO LIMPIO) --- */
    ...
    .header-container {
        ...
        position: relative;
        margin-top: -60px; /* Truco para subir el banner y tapar el hueco del header oculto */
        z-index: 999;
    }
    .logo-esquina {
